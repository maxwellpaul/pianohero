...
================================
-run_feature_extract.sh (shell script for temporarily setting environment variables and 
 executing the application)
   -to run the shell script, type
   
       ./run_feature_extract.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v93, run the shell script as:
       ...
       ./run_feature_extract.sh /mathworks/home/application/v93
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_feature_extract.sh /mathworks/devel/application/matlab
-MCRInstaller.zip 
    Note: if end users are unable to download the MATLAB Runtime using the
    instructions in the previous section, include it when building your 
    component by clicking the "Runtime downloaded from web" link in the
    Deployment Tool.
-The Macintosh bundle directory structure feature_extract.app 
    Note: this can be stored in an archive file with the zip command 
    zip -r feature_extract.zip feature_extract.app
    or the tar command 
    tar -cvf feature_extract.tar feature_extract.app
-This readme file 
...
${DYLD_LIBRARY_PATH}:MR/v93/runtime/maci64:MR/v93/sys/os/maci64:MR/v93/bin/maci64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_feature_extract.sh 
